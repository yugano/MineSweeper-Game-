    ...
    public class Game
    {
        ...
        public Actions ClickSquare(Clicks mouseClick, Squares clicked)
        {
            ...
            if (mouseClick == Clicks.RightClick)
            {
                ...
                // if the square is opened aldready then  right click will have no effect
                if (clicked.IsUncovered)
                {
                    return Actions.DoNothing;
                }

                // if the square has flag on it then flag will be removed
        ...
        // its all neighborhoods and itself is added in a list for opening all in once
        // and number of those added to the score
